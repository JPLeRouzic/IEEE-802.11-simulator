...
import IEEE11ax.layer0.axMediumInterferenceModel;
import zzInfra.layer1.JE802PhyMCS;

/**
 * @author Jean-Pierre Le Rouzic
 */
public class axMIMO_BF_SU {
public void chg_gain_bf_su (axMediumInterferenceModel mim, JE802PhyMCS aPhyMCS, axStation localsta, axStation distantsta, int nbanttenas) 
    {
    /*
  ...
  //      below is a skeleton only
    ...
    Map<Integer, Double> attenuations = axAttenuationTable.get(localkey);
