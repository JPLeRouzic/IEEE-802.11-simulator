 ...
 */
public class acMIMO_BF_SU {
public void chg_gain_bf_su (acMediumInterferenceModel mim, JE802PhyMCS aPhyMCS, acStation localsta, acStation distantsta, int nbanttenas) 
    {
    /*
  ...
  //      below is a skeleton only
    ...
    Map<Integer, Double> attenuations = acAttenuationTable.get(localkey);
